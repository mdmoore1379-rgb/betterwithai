...
export const offers: Offer[] = [
  {
    ...
    price: '$2,497',
    period: 'one-time',
    description: 'Self-serve only. No call required. Full operations + tech + marketing audit with prioritized, ROI-ranked plan. Buy, pay, and your project is live in the portal in minutes.',
    features: [
