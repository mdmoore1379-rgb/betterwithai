  ...
  return (
    <div className="min-h-screen bg-white text-[#111]">
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="mt-2 text-xl text-[#555]">Everything you need to get started and get results with betterwithai.</p>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="card p-8">
            ...
            <p className="mt-2 text-[#555]">This website isn&apos;t a brochure. It&apos;s the enduring front-end of our operating system, growth plan, and product ladder — designed so we evolve offers (Roadmap → Platform → Academy) without starting over.</p>
            ...
            <p className="mt-6 text-xs text-[#666]">One founder + this system + Grok = scalable production to $100M. Talk to me, I update the site and deploy.</p>

            <div className="mt-6">
              <h3 className="font-semibold text-sm">Socials (Holderness Family Vibe)</h3>
              <p className="text-xs text-[#555]">YouTube/Instagram/TikTok: Family travel + AI systems crushing work so we can actually live. The website is the engine; socials show the lifestyle. GrowthAgent generates the content ideas/scripts.</p>
            ...
            <div className="mt-6">
              ...
              <p className="text-xs text-[#555]">After signup or project start, clients log in with work Google or Microsoft 365 credentials. Personalized view of projects, invoices, contracts (with e-sign), and status. No more email chains — everything in one place, specific to their org.</p>
